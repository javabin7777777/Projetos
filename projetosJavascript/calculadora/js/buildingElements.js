...
export default  function buildElements(div) {   
    ...
    let X5 = `<button id="tan">tan</button><button id="rad" title="converter para radiano">rad</button><button id="grau" class="operator1">º</button><button id="sign" >+ -</button><button id="signE" title="Notacao cientifica">E</button><button id="parenthesis">( )</button>`;
    ...
    let X7 = `<button id="memory" title="Resultado da ultima operacao">MR</button><button id="lastOper" title="Ultima operacao">LO</button><button  onclick="window.location.reload()" title="Reset">R</button><button id="equal" class="grid-item1">=</button>`;
